...
void bk_sha256_finish(hal_sha_context *ctx,unsigned char output[32])
{
...
void hal_sha_update( void *ct, const unsigned char *input,size_t ilen )
{
    size_t fill;
    UINT32 left;
