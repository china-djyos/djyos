...
{
    printf("QSPI_CTRL=0x%lx \r\n", REG_READ(QSPI_CTRL));
    printf("QSPI_DCACHE_WR_CMD=0x%lx \r\n", REG_READ(QSPI_DCACHE_WR_CMD));
    printf("QSPI_DCACHE_WR_ADDR=0x%lx \r\n", REG_READ(QSPI_DCACHE_WR_ADDR));
    printf("QSPI_DCACHE_WR_DUM=0x%lx \r\n", REG_READ(QSPI_DCACHE_WR_DUM));
    printf("QSPI_DCACHE_WR_DAT=0x%lx \r\n", REG_READ(QSPI_DCACHE_WR_DAT));
    printf("QSPI_DCACHE_RD_CMD=0x%lx \r\n", REG_READ(QSPI_DCACHE_RD_CMD));
    printf("QSPI_DCACHE_RD_ADDR=0x%lx \r\n", REG_READ(QSPI_DCACHE_RD_ADDR));
    printf("QSPI_DCACHE_RD_DUM=0x%lx \r\n", REG_READ(QSPI_DCACHE_RD_DUM));
    printf("QSPI_DCACHE_RD_DAT=0x%lx \r\n", REG_READ(QSPI_DCACHE_RD_DAT));
    printf("QSPI_DCACHE_REQUEST=0x%lx \r\n", REG_READ(QSPI_DCACHE_REQUEST));
}
