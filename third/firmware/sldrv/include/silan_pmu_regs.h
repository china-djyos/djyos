...
{
	u32  write_key;         // offset 0x000
	u32  sys_ctr0;          // offset 0x004
	u32  sys_ctr1;          // offset 0x008
	u32  sys_ctr2;          // offset 0x00C
	u32  sys_sts;           // offset 0x010
	u32  sys_wdt_tg;           // offset 0x014
	u32  sys_pll_ctrl1;     // offset 0x018
	u32  sys_pll_ctrl2;    	// offset 0x01c
	u32  sscg;    						// offset 0x020
	u32  audio_pll_ctrl1;    // offset 0x024
	u32  audio_pll_ctrl2;    // offset 0x028
	u32  iso_en;
	u32  sys_wdt_clr;
}sysclk_struct_t;
