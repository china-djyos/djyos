...
int silan_iomux_adc_open(u8 channel);
int silan_iomux_adc_close(u8 channel);

void io_config(unsigned int mod,unsigned int func);
//void silan_pad_pullup_open(u32 addr, u32 pin);
//void silan_pad_pullup_close(u32 addr, u32 pin);
void silan_gpio_filsel_sel(u32 addr,u32 pin,int if_open);

void silan_io_pullup_config(unsigned int mod,unsigned int func);
void silan_io_func_config(u32 mod, u32 func);
