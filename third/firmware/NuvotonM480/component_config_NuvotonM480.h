...
//%$#@describe      ****组件描述开始
//component name:"Nuvoton M480"//填写该组件的名字，若是第三方组件，同时也是库的名字
...
//%$#@configue      ****参数配置开始
#if ( CFG_MODULE_ENABLE_NUVOTON_M480 == false )
//#warning  " Nuvoton_M480  组件参数未配置，使用默认配置"
//%$#@target = cmdline   //header = 生成头文件,cmdline = 命令行变量，DJYOS自有模块禁用
#define CFG_MODULE_ENABLE_NUVOTON_M480    false //如果勾选了本组件，将由DIDE在project_config.h或命令行中定义为true
//%$#@num,0,100
//%$#@enum,true,false
//%$#@string,1,16
//%$#@select
