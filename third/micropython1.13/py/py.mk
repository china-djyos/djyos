...
QSTR_GLOBAL_DEPENDENCIES += $(PY_SRC)/mpconfig.h $(DJYOSPORT)/mpconfigport.h
...
$(HEADER_BUILD)/qstrdefs.generated.h: $(PY_QSTR_DEFS) $(QSTR_DEFS) $(QSTR_DEFS_COLLECTED) $(PY_SRC)/makeqstrdata.py $(DJYOSPORT)/mpconfigport.h $(MPCONFIGPORT_MK) $(PY_SRC)/mpconfig.h | $(HEADER_BUILD)
	$(ECHO) "GEN $@"
