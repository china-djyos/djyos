...
static void yaffs_gross_lock(struct yaffs_dev *dev)
{
    ...
    Lock_MutexPend(&(yaffs_dev_to_lc(dev)->gross_lock));
...
static void yaffs_gross_unlock(struct yaffs_dev *dev)
{
    ...
    Lock_MutexPost(&(yaffs_dev_to_lc(dev)->gross_lock));
}
...
static void yaffs_put_super(struct super_block *sb)
{
    ...
    yaffs_gross_unlock(dev);
    Lock_MutexPend(&yaffs_context_lock);
    list_del_init(&(yaffs_dev_to_lc(dev)->context_list));
    Lock_MutexPost(&yaffs_context_lock);
                             ...
                             void *data, int silent)
{
    ...
    Lock_MutexCreate(&(yaffs_dev_to_lc(dev)->gross_lock));
...
static int __init init_yaffs_fs(void)
{
    ...
    Lock_MutexCreate(&yaffs_context_lock);
