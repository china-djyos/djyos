...
#define     CFG_DISPLAY_NAME                 "lcdili9325"        // "显示器名",须与bsp中显示器驱动模块配置的显示器名字相同
#define     CFG_DESKTOP_NAME                 "Desktop"           // "桌面名"
#define     CFG_INPUTDEV_NAME                "TOUCH_STMPE811"    // "输入设备名称",使用bsp中输入设备所配置的名字，多输入设备的话，每个设备间用逗号隔开
...
#define CFG_STDIO_IN_NAME              "/dev/UART2"  // "输入设备名",
#define CFG_STDIO_OUT_NAME             "/dev/UART2"  // "输出设备名",
#define CFG_STDIO_ERR_NAME             "/dev/UART2"  // "err输出设备名",
...
#define     CFG_I2C1_ENABLE                  true                // "是否配置使用IIC1",
#define     CFG_I2C2_ENABLE                  true                // "是否配置使用IIC2",
//******************************* Core Clock ******************************************//
