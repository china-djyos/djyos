...
//*******************************  Configure System:ascii charset  ******************************************//
...
//*******************************  Configure System: graphical kernel  ******************************************//
...
#define     CFG_INPUTDEV_NAME                "TOUCH_STMPE811"   //使用bsp中输入设备所配置的名字多输入设备的话每个设备间用逗号隔开
...
//*******************************  Configure chip driver stmpe811  ******************************************//
