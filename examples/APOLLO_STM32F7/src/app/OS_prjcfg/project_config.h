...
#define     CFG_EVENT_LIMIT                  22                //事件数量
#define     CFG_EVENT_TYPE_LIMIT             22                //事件类型数
...
#define     CFG_APP_FILENAME                 "app"             // CFG_APP_RUNMODE==EN_FORM_FILE这里配置文件名
...
#define     CN_TFTP_PATHDEFAULT                         //TFTP默认工作目录
...
#define     CFG_DHCPD_DOMAINNAME             "dhcp"            //"               //",
#define     CN_PPP_ENABLE                    1                 //是否需要 ppp 协议
//#define   CFG_MYCONFIG6                    null              //我的配置
...
#define     CFG_OPTIONS                      0                 //文件系统文件安装逻辑
#define     CFG_ECC                          0                 //YAF文件系统文件使能设备ECC功能
#define     CFG_DEFAULT_HEAP                 "extram"          //"    //",
#define     CFG_MOUNT_POINT                  ""                //YAF文件系统安装目录
#define     CFG_MOUNT_DEV                    ""                //YAF文件系统所在设备路径
//******************************* Core Clock ******************************************//
