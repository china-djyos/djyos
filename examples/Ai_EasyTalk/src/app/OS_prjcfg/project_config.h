...
//*******************************  Configure dhcp  ******************************************//
#define    CFG_DHCPD_ENABLE                true                // "DHCP 服务器使能"
...
#define     CFG_TCP_CCBNUM              15             // "tcp 客户端数限值"，占一个 指针 和 struct ClienCB
...
#define    CFG_DESKTOP_WIDTH               240                     // "桌面宽度",桌面尺寸（像素数）宽度，0=显示器宽度
#define    CFG_DESKTOP_HEIGHT              320                     // "桌面高度",桌面尺寸（像素数）高度，0=显示器高度
#define    CFG_DISPLAY_NAME                "lcdst7796s"        // "显示器名",须与bsp中显示器驱动模块配置的显示器名字相同
#define    CFG_DESKTOP_NAME                "desktop"        // "桌面名"
#define    CFG_INPUTDEV_NAME               "IoIic"       // "输入设备名称",使用bsp中输入设备所配置的名字，多输入设备的话，每个设备间用逗号隔开
...
#define    CFG_FAT_MEDIA_KIND              "MSC"             //媒体所属类别（ "MSC" "EMMC"）
#define    CFG_FAT_MOUNT_POINT             "fat"             //FAT文件系统安装目录
...
#define    CFG_ST7796S_HEAP_NAME           "PSRAM"                  // "驱动使用堆名",配置液晶驱动所使用的堆名称
//*******************************  Configure qspi  ******************************************//
