...
//*******************************  Configure ART32 common code  ******************************************//
#define    CFG_MODULE_ENABLE_ART32_COMMON_CODE  true
...
//*******************************  Core Clock  ******************************************//
#define    CFG_CORE_MCLK                   (288.0*Mhz)       //主频，内核要用，必须定义
...
#define    PRODUCT_BOARD_TYPE              "at-start-f437"   //板件类型
#define    PRODUCT_CPU_TYPE                "at32f437"        //CPU类型
