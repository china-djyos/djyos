...
//*******************************  Configure at24c02  ******************************************//
#define CFG_AT24_TIMEOUT           (-1)   //-1表示无穷
#define CFG_AT24_ADDRESS            0xA0                //硬件配置AT24的IIC设备地址
#define CFG_AT24_CLK_FRE           (100*1000)           //单位Hz
#define CFG_AT24C02_BUS_NAME       "I2C0"        //AT24使用的总线
