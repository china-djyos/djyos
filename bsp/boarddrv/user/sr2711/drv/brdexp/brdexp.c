...
#define RECORD_EXP_START_PAGE      (130560)    //异常存储起始页
#define RECORD_EXP_END_PAGE        (131071)   //异常存储结束页
#define RECORD_EXP_START_BLOCK     (2040)    //异常存储起始block
#define RECORD_EXP_END_BLOCK       (2047)    //异常存储结束block
