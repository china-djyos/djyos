...
#define KO4    {GPIO_G, PIN10, GPIO_MODE_OUT, GPIO_OTYPE_PP, GPIO_SPEED_VH,GPIO_PUPD_NONE}
#define KO5    {GPIO_G, PIN11, GPIO_MODE_OUT, GPIO_OTYPE_PP, GPIO_SPEED_VH,GPIO_PUPD_NONE}
#define KO6    {GPIO_G, PIN12, GPIO_MODE_OUT, GPIO_OTYPE_PP, GPIO_SPEED_VH,GPIO_PUPD_NONE}
...
#define KI6       {GPIO_F, PIN3, GPIO_MODE_IN, GPIO_OTYPE_PP, GPIO_SPEED_VH,GPIO_PUPD_NONE}
#define KI7       {GPIO_F, PIN4, GPIO_MODE_IN, GPIO_OTYPE_PP, GPIO_SPEED_VH,GPIO_PUPD_NONE}
