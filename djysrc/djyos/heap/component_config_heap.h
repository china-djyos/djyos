...
#ifndef CFG_DYNAMIC_MEM   //****检查参数是否已经配置好
#warning    heap组件参数未配置，使用默认值
//%$#@num,0,100,
#define CFG_DYNAMIC_MEM 1  //"是否支持动态分配",1 = 支持动态内存分配，即使不支持，也允许使用malloc-free分配内存，但使用有差别，详见《……用户手册》内存分配章节
//%$#@enum,true,false
//%$#@string,1,10
